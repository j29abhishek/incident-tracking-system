    ...
    <div className="dash-wrapper">
      ...
      <div className="dash-container">
        ...
        <aside className={`dash-sidebar ${openMenu ? "open" : ""}`}>
          ...
          <NavLink to="services" className="dash-menu-item">
            <FontAwesomeIcon icon={faCogs} className="menu-icon" />
            <span>Services</span>
          </NavLink>

          <NavLink to="manage-services" className="dash-menu-item">
            <FontAwesomeIcon icon={faUsersCog} className="menu-icon" />
            <span>Service Management</span>
          </NavLink>

          <NavLink to="admin-incidents" className="dash-menu-item">
            <FontAwesomeIcon
          ...
          <NavLink to="incidents-status" className="dash-menu-item">
